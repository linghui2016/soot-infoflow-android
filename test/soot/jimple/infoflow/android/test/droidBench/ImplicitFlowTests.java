...
public class ImplicitFlowTests extends JUnitTests {
	...
	public void runTestImplicitFlow1() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("ImplicitFlows"+File.separator+"ImplicitFlow1.apk", true);
	...
	public void runTestImplicitFlow2() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("ImplicitFlows"+File.separator+"ImplicitFlow2.apk", true);
	...
	public void runTestImplicitFlow3() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("ImplicitFlows"+File.separator+"ImplicitFlow3.apk", true);
		Assert.assertNotNull(res);
		Assert.assertEquals(2, res.size());
	}
	...
	public void runTestImplicitFlow4() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("ImplicitFlows"+File.separator+"ImplicitFlow4.apk", true);
		Assert.assertNotNull(res);
		Assert.assertEquals(2, res.size());
	}
	...
	public void runTestImplicitFlow5() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("ImplicitFlows"+File.separator+"ImplicitFlow5.apk", true);
		Assert.assertNotNull(res);
